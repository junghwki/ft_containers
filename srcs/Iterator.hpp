...
namespace ft
{
	...
	public:
		...
		{
			return (reverse_iterator(mCurrent - __n));
		}
	...
	operator-(const reverse_iterator<_Iterator> &__x, const reverse_iterator<_Iterator2> &__y)
	{
		return (__y.base() - __x.base());
	}
